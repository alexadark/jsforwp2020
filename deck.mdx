...
- Headless WordPress Advocate and JAMStack enthousiast
- Speaker at [javascriptforwp2019](https://www.youtube.com/watch?v=zKSaj_JgXBk)
- Speaker at [Gatsby Days London](https://www.youtube.com/watch?v=pFJneJwtIuY)
- 🖥️ Co-founder [Gatsby Wp Themes](https://gatsbywpthemes.com/)
...
<Grid columns={2} gap={50} sx={{'div':{ p:10, bg:'#39376d'}}}>
...
<ul>
  ...
  <li>customization: trough shadowing wich allows users to override a component in order to customize its rendering</li>
...
- WordPress Plugins: [WPGraphQl](https://www.wpgraphql.com/wpgra), [WPGatsby](https://wordpress.org/plugins/wp-gatsby/)
- Gatsby Plugins: [gatsby-wordpress-source-experimental](https://www.gatsbyjs.org/packages/gatsby-source-wordpress-experimental/?=wordpre)
...
<Grid columns={3} gap={100}>
  <TeamMember
    ...
    url="https://alexandraspalato.com/"
  />
  <TeamMember src={Zac} name="Zac Gordon" url="https://www.zacgordon.com/" />
  <TeamMember src={Paulina} name="Paulina Hetman" url="https://pehaa.com/" />
</Grid>
